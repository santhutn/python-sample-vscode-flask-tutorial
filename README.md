[![Build Status](https://dev.azure.com/santhutn/SampleProject/_apis/build/status/santhutn.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/santhutn/SampleProject/_build/latest?definitionId=8&branchName=master)
